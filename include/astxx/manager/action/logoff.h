...
/** @file
 *
 * Include this file to use the logoff action.  It will be included 
 * automatically by including astxx/manager.h.
 */

#ifndef ASTXX_MANAGER_ACTION_LOGOFF_H
#define ASTXX_MANAGER_ACTION_LOGOFF_H
...
namespace astxx {
   namespace manager {
      namespace action {
         ...
         class logoff : public basic_action {
            public:
               message::action action() const {
                  return message::action("Logoff");
               }
         };
      }
   }
