...
/** @file
 *
 * Include this file to use the MailboxStatus action.  It will be included 
...
namespace astxx {
   namespace manager {
      namespace action {
         ...
         /// Get the status of a voicemail box.
         class mailbox_status : public basic_action {
            public:
               /** Get the status of a voicemail box.
                * @param mailbox the mailbox to check
                */
               mailbox_status(const std::string& mailbox)
                  : mailbox(mailbox) {
               }
               
               message::action action() const {
                  message::action action("MailboxStatus");
